...
pub fn create_settings(denshokan_address: ContractAddress, game_address: ContractAddress, settings_id: u32, data: ByteArray) {
    let denshokan_dispatcher = IDenshokanDispatcher { contract_address: denshokan_address };
    denshokan_dispatcher.create_settings(game_address, settings_id, data);
}
