use game_components_minigame::extensions::settings::interface::{IMinigameSettings, IMinigameSettingsDispatcher, IMinigameSettingsDispatcherTrait, IMINIGAME_SETTINGS_ID};
...
mod MockSettingsContract {
    ...
    fn constructor(ref self: ContractState) {
        ...
        self.settings_data.write(1, GameSettingDetails {
            name: "Easy Mode",
        ...
        self.settings_data.write(2, GameSettingDetails {
            name: "Hard Mode",
    ...
    #[abi(embed_v0)]
    fn create_test_settings(ref self: ContractState, settings_id: u32, settings: GameSettingDetails) {
...
fn test_initialize_settings_component() {
    ...
    assert!(src5_dispatcher.supports_interface(IMINIGAME_SETTINGS_ID), "Should support IMinigameSettings");
...
fn test_get_settings_valid_id() {
    ...
    assert!(settings1.description == "Beginner friendly settings", "Settings 1 description mismatch");
...
fn test_create_settings_50_items() {
    ...
    loop {
        ...
        settings_items.append(GameSetting {
            name: "setting_" + i.to_string(),
...
trait ISettingsSetter<TContractState> {
    fn create_test_settings(ref self: TContractState, settings_id: u32, settings: GameSettingDetails);
}