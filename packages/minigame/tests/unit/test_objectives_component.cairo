use game_components_minigame::extensions::objectives::interface::{IMinigameObjectives, IMinigameObjectivesDispatcher, IMinigameObjectivesDispatcherTrait, IMINIGAME_OBJECTIVES_ID};
...
mod MockObjectivesContract {
    ...
    #[abi(embed_v0)]
    impl ObjectivesImpl = ObjectivesComponent::MinigameObjectivesImpl<ContractState>;
    ...
    fn _create_objective(
        ...
        self.objective_details.write(objective_id, ObjectiveDetails {
            objective_id,
            points,
            name: name.clone(),
...
fn test_initialize_objectives_component() {
    ...
    assert!(src5_dispatcher.supports_interface(IMINIGAME_OBJECTIVES_ID), "Should support IMinigameObjectives");
...
fn test_completed_objective() {
    ...
    assert!(!objectives_dispatcher.completed_objective(1, 2), "Objective 2 should not be completed");
}
