...
#[starknet::interface]
pub trait IEternumMock<TContractState> {
    fn mint_game(
...
mod eternum_mock {
    ...
    #[abi(embed_v0)]
    impl EternumMockImpl of super::IEternumMock<ContractState> {
        fn mint_game(
    ...
    impl GameContextImpl of IMetagameContext<ContractState> {
        ...
        fn context(self: @ContractState, token_id: u64) -> GameContextDetails {
            ...
            GameContextDetails {
                name: "Eternum",
                description: "Multiplayer Civilization with a real economy that never sleeps",
